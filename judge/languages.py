...
//APPEND END""",
    "compile": {
        ...
        "max_real_time": 20000,
        "max_memory": 1024 * 1024 * 1024,
        "compile_command": "/usr/bin/g++ -DONLINE_JUDGE -O2 -w -fmax-errors=3 -std=c++23 {src_path} -lm -o {exe_path}",
    },
    "run": {
        "command": "{exe_path}",
        "seccomp_rule": {ProblemIOMode.standard: "c_cpp", ProblemIOMode.file: "c_cpp_file_io"},
...
_cpp_lang_spj_compile = {
    ...
    "max_real_time": 20000,
    "max_memory": 1024 * 1024 * 1024,
    "compile_command": "/usr/bin/g++ -I/spjinclude -DONLINE_JUDGE -O2 -w -fmax-errors=3 -std=c++23 {src_path} -lm -o {exe_path}"
}
...
//APPEND END""",
    ...
    "run": {
        "command": "/usr/bin/pypy3 -BS {exe_path}",
        "seccomp_rule": "general",
        "env": default_env
    }
}
...
languages = [
    {"config": _c_lang_config, "name": "C", "description": "GCC 14", "content_type": "text/x-csrc",
      "spj": {"compile": _c_lang_spj_compile, "config": _c_lang_spj_config}},
    {"config": _cpp_lang_config, "name": "C++", "description": "GCC 14", "content_type": "text/x-c++src", 
    ...
    {"config": _py3_lang_config, "name": "Python3", "description": "Python 3.13", "content_type": "text/x-python"},
    {"config": _pypy3_lang_config, "name": "PyPy3", "description": "PyPy 3.11", "content_type": "text/x-python"},
